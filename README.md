...
This repository follow the original transformer from the paper with 6 encoder and 6 decoder layers and 8 heads for each multi-head attention layer and the rest can be noticed in the transformer architecture figure to th right, totaling `***` learnable parameters.
