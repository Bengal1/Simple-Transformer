...
*Self-Attention:* &emsp; *Cross-Attention:* <br/>
$`X·W_{q} = Q∈ℝ^{M×d_k}`$ &emsp; $`X·W_q = Q∈ℝ^{M×d_k}`$ <br/>
$`X·W_{k} = K∈ℝ^{M×d_k}`$ &emsp; $`C·W_k = K∈ℝ^{L×d_k}`$ <br/>
$`X·W_{v} = V∈ℝ^{M×d_v}`$ &emsp; $`C·W_v = V∈ℝ^{L×d_v}`$ <br/>  
