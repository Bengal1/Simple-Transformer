...
[Large Language Models (LLMs)](https://en.wikipedia.org/wiki/Large_language_model), such as GPT, are built on the Transformer architecture, which made it possible to scale language models to billions of parameters and achieve state-of-the-art performance in NLP.
