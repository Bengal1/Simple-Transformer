...
In our model the *Feed-Forward* network compose of 2 fully-connected and a ReLU activation that applied between them. I also applied drop out according to "Attention Is All You Need". <br/> 
