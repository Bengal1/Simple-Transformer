...
After calculating the positional encoding vectors, $`[p_1, p_2, p_3,..., p_M]`$, we adds the to the embedding vectors, $`[e_1, e_2, e_3,..., e_M]`$ :<br/> $`[e_1 + p_1, e_2 + p_2, e_3 + p_3,..., e_M + p_M]`$ 
