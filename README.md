...
By focusing on a smaller dataset, we provide a fair baseline for understanding translation quality when training data is limited, while keeping other training details such as number of layers, embedding dimensions, and attention heads, consistent with the original paper.
