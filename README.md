...
<br/>As a result, even when configured like Transformer-Base, our model contains more parameters, reflecting design choices that emphasize richer vocabulary coverage under data-limited conditions.
